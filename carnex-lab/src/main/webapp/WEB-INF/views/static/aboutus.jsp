...
<%@ include file="../includes/header.jsp" %>
  ...
  <script>
    $(function () {
      $('.tabsBtn').click(function (event) { // event : 이벤트 객체
        event.preventDefault(); // 브라우저의 기본 기능(하이퍼 링크)을 제거한다.
        // 탭버튼과 탭내용에 있는 클래스명 'on'을 제거한다.
        $('.tabsBtn').removeClass('on');
        $('.au-lt-container > div').removeClass('on');
        
        // 클릭한 탭버튼(this:실행중인 객체)에 'on' 클래스명을 넣는다.
        $(this).addClass('on');
        // 클릭한 탭버튼의 다음 요소(탭내용)에 'on' 클래스명을 넣는다.
...
<div class="bn au-bn-bg">
  ...
  <section>
    ...
    <ul class="au-vs">
      <li>
        <div class="au-vs-bg au-vs-bg1">
          <div class="vs-cover">
            <p>Vehicle Information</p>
          </div> 
            <div class="au-vs-txt">
              <h4>열려있는 구조</h4>
              <p>열려있는 구조로 남녀노소 모두에게 편리하게 ...</p>
              <div class="vs-btn">More</div>
            </div>    
		    </div>
      </li>
      <li>
        <div class="au-vs-bg au-vs-bg2">
          <div class="vs-cover">
            <p>Perfect Commercialization Processing</p>
          </div> 
            <div class="au-vs-txt">
              <h4>완벽한 상품화처리</h4>
              <p>완벽한 상품화처리를 하여
      ...
      <li>
        <div class="au-vs-bg au-vs-bg3">
          <div class="vs-cover">
            <p>Vehicle Information Provided</p>
            
          </div> 
            <div class="au-vs-txt">
              <h4>차량 정보를 제공</h4>
              <p>고객에게 클릭 한 번에 모든 차량의     
                정보 제공
             ...</p>
            <div class="vs-btn">More</div>
            </div>
      ...
      <div class="au-lt-wrap on first">
        <div class="au-lt-bg lt-inner1">
          <!-- <svg width="100%" height="100%">
            <line x1="10" x2="1780" y1="0" y2="0" class="top"></line>
            <line x1="0" x2="0" y1="480" y2="-1580" class="left"></line>
            <line x1="590" x2="-1780" y1="480" y2="480" class="bottom"></line>
            <line x1="600" x2="600" y1="0" y2="1580" class="right"></line>
          </svg> -->
          <svg width="100%" height="100%">
          ...
          <div class="au-lt-txt"> 
            <svg viewBox="0 0 30 40" class="au-lt-svg">
              <text x="50%" y="60%" text-anchor="middle">회 사 내 부</text>
            </svg>
          </div>
        </div>
        <div class="au-lt-bg lt-outer1">
          ...
          <div class="au-lt-txt">   
            <svg viewBox="0 0 30 40" class="au-lt-svg">
              <text x="50%" y="60%" text-anchor="middle">회 사 전 경</text>
            </svg>
          </div>  
        </div>
